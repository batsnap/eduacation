...
for i in a.keys():
   newlist.append(i)
class MainApp(App):
   def change_number(self,instance):
      global c,x
      if(str(instance.text).lower()==a.get(newlist[c])):
         c=randint(0,185)
         self.lbl.text=newlist[c]
      else:
         x+=1
         self.lbl2.text='ошибки:'+str(x)
         pass
   def build(self):
      bl=BoxLayout(orientation='vertical',padding=25)
      gl=GridLayout(cols=2)
      self.lbl2=Label(text='ошибки:'+str(x))
      self.lbl=Label(text=newlist[c])
      
      bl.add_widget(self.lbl)
      bl.add_widget(self.lbl2)
      gl.add_widget(Button(text="е",on_press=self.change_number))
      gl.add_widget(Button(text="я",on_press=self.change_number))
      gl.add_widget(Button(text="и",on_press=self.change_number))
      gl.add_widget(Button(text="а",on_press=self.change_number))
      gl.add_widget(Button(text="о",on_press=self.change_number))
      gl.add_widget(Button(text="ы",on_press=self.change_number))
      bl.add_widget(gl)
      return bl
